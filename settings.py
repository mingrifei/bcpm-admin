...
DEFAULT_DB_DBHOST = os.getenv('DEFAULT_DB_DBHOST', '122.112.238.137')
DEFAULT_DB_DBPORT = os.getenv('DEFAULT_DB_DBPORT', '4407')
DEFAULT_DB_DBUSER = os.getenv('DEFAULT_DB_DBUSER', 'root')
DEFAULT_DB_DBPWD = os.getenv('DEFAULT_DB_DBPWD', 'kingdom88')
DEFAULT_DB_DBNAME = os.getenv('DEFAULT_DB_DBNAME', 'bcpm')

READONLY_DB_DBHOST = os.getenv('READONLY_DB_DBHOST', '122.112.238.137')
READONLY_DB_DBPORT = os.getenv('READONLY_DB_DBPORT', '4407')
READONLY_DB_DBUSER = os.getenv('READONLY_DB_DBUSER', 'root')
READONLY_DB_DBPWD = os.getenv('READONLY_DB_DBPWD', 'kingdom88')
READONLY_DB_DBNAME = os.getenv('READONLY_DB_DBNAME', 'bcpm')
