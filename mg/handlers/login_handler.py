...
class LoginHandler(RequestHandler):
    ...
    def post(self, *args, **kwargs):
        ...
        self.set_secure_cookie("email", user_info.nickname)
        ...
        return self.write(dict(code=0, auth_key=auth_key.decode(), username=user_info['username'],
                               nickname=user_info['nickname'], lastip=user_info['last_ip'],lastlogin=user_info['last_login'],msg='登录成功'))


class LogoutHandler(BaseHandler):
    def get(self):
        self.clear_all_cookies()
        return self.write(dict(code=0, msg='退出成功'))
...
login_urls = [
    ...
    (r"/api/authorization/", AuthorizationHandler),
]
